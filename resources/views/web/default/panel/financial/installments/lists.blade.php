                                ...
                                <div class="webinar-card-body w-100 d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-45">
                                        ...
                                        <div class="d-flex align-items-start flex-column mt-5 mr-15">
                                            ...
                                            <span
                                                class="stat-value mt-20">{{ dateTimeFormat($order->created_at, 'j M Y H:i') }}</span>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                            ...
                                            <span
                                                class="stat-value mt-20">{{ trans('update.total_parts_count', ['count' => $order->selectedInstallment->steps_count + 1]) }}
                                        ...
                                        @if ($order->status == 'open' or $order->status == 'pending_verification')
                                            <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                ...
                                                <span
                                                    class="stat-value mt-20">{{ trans('update.total_parts_count', ['count' => $order->remained_installments_count]) }}
                                            ...
                                            @if ($order->has_overdue)
                                                <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                                    ...
                                                    <span class="stat-value mt-20">{{ $order->overdue_count }}
                                                ...
                                                <tbody>
                                                    ...
                                                    @if (!empty($order->selectedInstallment->upfront))
                                                        ...
                                                        <tr>
                                                            <td class="">
                                                                <span
                                                                    class="font-16 font-weight-500 text-dark-blue text-left">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                @else
                                                                    <span
                                                                        class="text-dark-blue">{{ trans('update.unpaid') }}</span>
                                                                @endif
                                                            </td>
                                                            <td class="text-right">
                                                    ...
                                                    @foreach ($order->selectedInstallment->steps as $step)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                {{ handlePrice($step->getPrice($itemPrice)) }}</td>
