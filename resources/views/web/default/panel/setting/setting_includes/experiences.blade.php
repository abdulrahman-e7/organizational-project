        ...
        @if (!empty($experiences) and !$experiences->isEmpty())
            @foreach ($experiences as $experience)
                <div class="row mt-20">
                    <div class="col-12">
                        <div
                            class="experience-card py-15 py-lg-30 px-10 px-lg-25 rounded-sm panel-shadow bg-white d-flex align-items-center justify-content-between">
                            <div class="col-10 text-secondary font-weight-500 text-left experience-value"
                                ...
                                @if (preg_match($pattern, $experience->value, $matches))
                                    <div class="row">
                                        ...
                                        <p class="col-12 col-sm-6">
                                            عدد سنوات الخبرة: {{ trans('application_form.'.$matches[2]) }}
                                        </p>
                                    </div>
                                @else
                                    {{ $experience->value }}
...
<div class="d-none" id="newExperienceModal">
    ...
    <div class="mt-20">
        ...
        <div class="form-group mt-15 px-50">
            ...
            <input type="text" id="new_experience_val" required class="form-control" placeholder="اكتب مجال الخبرة">
            <div class="invalid-feedback">{{ trans('validation.required', ['attribute' => 'مجال الخبرة']) }}</div>
        </div>

        <div class="form-group mt-15 px-50">
            <label class="form-label text-left">
            أختر عدد سنوات الخبرة
                <span class="text-danger">*</span></label>
